...
from http_retry import request_json, request_with_retries
...
class TOOL(object):
    ...
    def _get_server_time(self):
        response = request_json('GET', 'https://api.mexc.com/api/v3/time')
    ...
    def public_request(self, method, url, params=None):
        ...
        return request_with_retries(method, url, params=params) or EmptyResponse(url)
    ...
    def sign_request(self, method, url, params=None):
        ...
        return request_with_retries(method, url, params=params, headers=headers) or EmptyResponse(url)
